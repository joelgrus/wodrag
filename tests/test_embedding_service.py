...
class TestEmbeddingService:
    ...
    def test_initialization_success(self, mock_getenv: MagicMock, mock_create: MagicMock) -> None:
    ...
    @patch("wodrag.services.embedding_service.openai.embeddings.create")
    @patch("wodrag.services.embedding_service.os.getenv")
    def test_generate_embedding_success(self, mock_getenv: MagicMock, mock_create: MagicMock) -> None:
        mock_getenv.return_value = "test-api-key"
    ...
    @patch("wodrag.services.embedding_service.openai.embeddings.create")
    @patch("wodrag.services.embedding_service.os.getenv")
    def test_generate_embedding_strips_whitespace(self, mock_getenv: MagicMock, mock_create: MagicMock) -> None:
        mock_getenv.return_value = "test-api-key"
    ...
    @patch("wodrag.services.embedding_service.openai.embeddings.create")
    @patch("wodrag.services.embedding_service.os.getenv")
    def test_generate_embedding_api_error(self, mock_getenv: MagicMock, mock_create: MagicMock) -> None:
        mock_getenv.return_value = "test-api-key"
    ...
    @patch("wodrag.services.embedding_service.openai.embeddings.create")
    @patch("wodrag.services.embedding_service.os.getenv")
    def test_generate_batch_embeddings_success(self, mock_getenv: MagicMock, mock_create: MagicMock) -> None:
        mock_getenv.return_value = "test-api-key"
        mock_embeddings = [
    ...
    @patch("wodrag.services.embedding_service.openai.embeddings.create")
    @patch("wodrag.services.embedding_service.os.getenv")
    def test_generate_batch_embeddings_with_empty_texts(self, mock_getenv: MagicMock, mock_create: MagicMock) -> None:
        mock_getenv.return_value = "test-api-key"
    ...
    @patch("wodrag.services.embedding_service.openai.embeddings.create")
    @patch("wodrag.services.embedding_service.os.getenv")
    def test_generate_batch_embeddings_api_error(self, mock_getenv: MagicMock, mock_create: MagicMock) -> None:
        mock_getenv.return_value = "test-api-key"
